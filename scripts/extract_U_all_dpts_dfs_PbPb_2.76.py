...
def map_to_exp_bins(ptedges_exp, ptlist_sim, counts_fine):
    """
    Sum fine simulation counts into coarser experimental pT bins.

    Parameters
    ----------
    ptedges_exp  : (N_exp+1,)  experimental bin edges
    ptlist_sim   : (Npt_sim,)  simulation bin centres
    counts_fine  : (..., Npt_sim)  last axis is pT
